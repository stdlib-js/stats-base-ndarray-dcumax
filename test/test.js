...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof dcumax, 'function', 'main export is a function' );
	t.end();
});

tape( 'the function has an arity of 1', function test( t ) {
	t.strictEqual( dcumax.length, 1, 'has expected arity' );
	t.end();
});
...
tape( 'the function calculates the cumulative maximum value of a one-dimensional ndarray', function test( t ) {
	...
	expected = new Float64Array( [ 1.0, 1.0, 1.0, 5.0, 5.0, 5.0 ] );
